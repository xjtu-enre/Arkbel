...
import { DestructuringTransformer, convertVariableDeclaration, convertAssignmentExpression, unshiftForXStatementBody, } from "./util.ts";
        ...
        visitor: {
            ...
            ForXStatement(path) {
                ...
                if (t.isPattern(left)) {
                    ...
                    nodes.unshift(t.expressionStatement(t.assignmentExpression("=", left, t.cloneNode(temp))));
            ...
            VariableDeclaration(path, state) {
                ...
                if (!parent || !path.container)
                    return; // i don't know why this is necessary - TODO
