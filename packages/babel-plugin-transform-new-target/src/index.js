        ...
        visitor: {
            MetaProperty(path) {
                ...
                if (meta.isIdentifier({ name: "new" }) &&
                    ...
                    const constructor = t.memberExpression(t.thisExpression(), t.identifier("constructor"));
                    if (func.isClass()) {
                    ...
                    path.replaceWith(t.conditionalExpression(t.binaryExpression("instanceof", t.thisExpression(), t.cloneNode(node.id)), constructor, scope.buildUndefinedNode()));
                }
            },
        },
    };
