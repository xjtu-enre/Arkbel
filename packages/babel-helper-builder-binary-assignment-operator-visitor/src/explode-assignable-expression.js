import { assignmentExpression, cloneNode, isIdentifier, isLiteral, isMemberExpression, isPrivateName, isPureish, isSuper, memberExpression, toComputedKey, } from "@babel/types";
...
function getPropRef(node, nodes, scope) {
    ...
    if (isLiteral(key) && isPureish(key))
        return key;
