        ...
        if (exactGlobals) {
            ...
            if (globalRef) {
                memberExpression = globalRef
                    .split(".")
                    .reduce((accum, curr) => t.memberExpression(accum, t.identifier(curr)), t.identifier("global"));
            }
            else {
        ...
        visitor: {
            Program: {
                exit(path) {
                    ...
                    if (moduleName)
                        moduleNameLiteral = t.stringLiteral(moduleName);
                    ...
                    for (const [source, metadata] of meta.source) {
                        ...
                        commonjsArgs.push(t.callExpression(t.identifier("require"), [
