        ...
        visitor: {
            LogicalExpression(path) {
                ...
                noDocumentAll
                    ...
                    : t.logicalExpression("&&", t.binaryExpression("!==", assignment, t.nullLiteral()), t.binaryExpression("!==", t.cloneNode(ref), scope.buildUndefinedNode())), t.cloneNode(ref), node.right));
            },
        },
    };
});
