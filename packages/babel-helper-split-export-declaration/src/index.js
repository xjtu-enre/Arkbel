import { cloneNode, exportNamedDeclaration, exportSpecifier, identifier, variableDeclaration, variableDeclarator, } from "@babel/types";
    ...
    if (exportDeclaration.isExportDefaultDeclaration()) {
        ...
        const updatedDeclaration = standaloneDeclaration
            ...
            : variableDeclaration("var", [
                variableDeclarator(cloneNode(id), 
