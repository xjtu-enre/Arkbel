        ...
        for (const prop of props) {
            if (t.isSpreadElement(prop)) {
                ...
                if (t.isArrayExpression(spreadLiteral) && hasHole(spreadLiteral)) {
                    spreadLiteral = t.callExpression(file.addHelper(process.env.BABEL_8_BREAKING
                        ? "arrayLikeToArray"
                        : "arrayWithoutHoles"), [spreadLiteral]);
                }
        ...
        visitor: {
            ...
            CallExpression(path) {
                ...
                if (t.isMemberExpression(callee)) {
                    ...
                    if (temp) {
                        callee.object = t.assignmentExpression("=", temp, 
            ...
            NewExpression(path) {
                ...
                path.replaceWith(t.callExpression(path.hub.addHelper("construct"), [
                    node.callee,
                    args,
                ]));
            },
