...
export function validatePlugins(plugins) {
    if (hasPlugin(plugins, "decorators")) {
        ...
        if (allowCallParenthesized != null &&
    ...
    if (hasPlugin(plugins, "moduleAttributes")) {
        if (process.env.BABEL_8_BREAKING) {
            ...
            if (moduleAttributesVersionPluginOption !== "may-2020") {
                throw new Error("The 'moduleAttributes' plugin requires a 'version' option," +
    ...
    if (hasPlugin(plugins, "recordAndTuple") &&
        ...
        throw new Error("The 'syntaxType' option of the 'recordAndTuple' plugin must be one of: " +
    ...
    if (hasPlugin(plugins, "optionalChainingAssign") &&
        getPluginOption(plugins, "optionalChainingAssign", "version") !== "2023-07") {
        throw new Error("The 'optionalChainingAssign' plugin requires a 'version' option," +
            " representing the last proposal update. Currently, the" +
