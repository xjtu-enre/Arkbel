...
export default declare((api, options, dirname) => {
    api.assertVersion(process.env.BABEL_8_BREAKING && process.env.IS_PUBLISH
        ...
        : 7);
    const { helpers: useRuntimeHelpers = true, version: runtimeVersion = "7.0.0-beta.0", absoluteRuntime = false, } = options;
    if (typeof useRuntimeHelpers !== "boolean") {
        throw new Error("The 'helpers' option must be undefined, or a boolean.");
    }
    if (typeof absoluteRuntime !== "boolean" &&
    ...
    if (has(options, "useBuiltIns")) {
        ...
        if (options["useBuiltIns"]) {
            throw new Error("The 'useBuiltIns' option has been removed. The @babel/runtime " +
                "module now uses builtins by default.");
        }
        else {
            throw new Error("The 'useBuiltIns' option has been removed. Use the 'corejs'" +
    ...
    if (has(options, "polyfill")) {
        ...
        if (options["polyfill"] === false) {
            throw new Error("The 'polyfill' option has been removed. The @babel/runtime " +
                "module now skips polyfilling by default.");
        }
        else {
            throw new Error("The 'polyfill' option has been removed. Use the 'corejs'" +
                "option to polyfill with `core-js` via @babel/runtime.");
        }
    }
    if (has(options, "moduleName")) {
        throw new Error("The 'moduleName' option has been removed. @babel/transform-runtime " +
    ...
    if (process.env.BABEL_8_BREAKING) {
        if (has(options, "regenerator")) {
            throw new Error("The 'regenerator' option has been removed. The generators transform " +
    ...
    if (process.env.BABEL_8_BREAKING) {
        if (has(options, "useESModules")) {
            throw new Error("The 'useESModules' option has been removed. @babel/runtime now uses " +
        ...
        // eslint-disable-next-line no-var
        var esModules = useESModules === "auto"
            ? api.caller(
    ...
    return {
        ...
        inherits: process.env.BABEL_8_BREAKING
            ? options.corejs
                ...
                : undefined
            : babel7.createPolyfillPlugins(options, runtimeVersion, absoluteRuntime, options.corejs === 3 ||
        ...
        pre(file) {
            ...
            file.set("helperGenerator", (name) => {
                ...
                let helperPath = `${modulePath}/helpers/${!process.env.BABEL_8_BREAKING &&
                    esModules &&
            ...
            function addDefaultImport(source, nameHint, blockHoist, isHelper = false) {
                ...
                if (cached) {
                    ...
                    cached = addDefault(file.path, source, {
                        importedInterop: (process.env.BABEL_8_BREAKING
                            ? isHelper
