        ...
        visitor: {
            AssignmentExpression(path) {
                ...
                if (t.isMemberExpression(left)) {
                    ...
                    if (memo) {
                        left.object = memo;
                        lhs.object = t.assignmentExpression("=", t.cloneNode(memo), 
                    ...
                    if (computed) {
                        ...
                        if (memo) {
                            left.property = memo;
                            lhs.property = t.assignmentExpression("=", t.cloneNode(memo), 
                ...
                operatorTrunc, lhs, t.assignmentExpression("=", left, right)));
            },
        },
    };
});
