...
import { arrowFunctionExpression, assertExpression, assignmentExpression, blockStatement, callExpression, cloneNode, expressionStatement, isAssignmentExpression, isCallExpression, isExportNamedDeclaration, isExpression, isIdentifier, isSequenceExpression, isSuper, thisExpression, } from "@babel/types";
/**
...
export function insertBefore(nodes_) {
    ...
    if (parentPath.isExpressionStatement() ||
        ...
        const shouldInsertCurrentNode = node &&
...
function isHiddenInSequenceExpression(path) {
    return (isSequenceExpression(path.parent) &&
...
function isAlmostConstantAssignment(node, scope) {
    ...
    return (blockScope.hasOwnBinding(node.left.name) &&
