...
import { STATEMENT_OR_BLOCK_KEYS, VISITOR_KEYS, isBlockStatement, isExpression, isIdentifier, isLiteral, isStringLiteral, isType, matchesPattern as _matchesPattern, } from "@babel/types";
/**
...
export function referencesImport(moduleSource, importName) {
    if (!this.isReferencedIdentifier()) {
        if ((this.isJSXMemberExpression() &&
            ...
            return (object.isReferencedIdentifier() &&
...
function getOuterFunction(path) {
    return path.isProgram()
        ...
        : (path.parentPath.scope.getFunctionParent() ||
            path.parentPath.scope.getProgramParent()).path;
}
