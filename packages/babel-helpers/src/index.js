...
import { assignmentExpression, cloneNode, expressionStatement, file, identifier, } from "@babel/types";
...
function loadHelper(name) {
    if (!helperData[name]) {
        ...
        const fn = () => {
            ...
            return new FileClass({ filename: `babel-helper://${name}` }, {
                ast: file(helper.ast()),
