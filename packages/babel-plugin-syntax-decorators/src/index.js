...
export default declare((api, options) => {
    ...
    if (process.env.BABEL_8_BREAKING) {
        if (version === undefined) {
            throw new Error("The decorators plugin requires a 'version' option, whose value must be one of: " +
        ...
        if (decoratorsBeforeExport === undefined) {
            if (version === "2021-12" || version === "2022-03") {
                ...
                throw new Error("The decorators plugin, when .version is '2018-09' or not specified," +
