...
const availablePlugins = {
    ...
    "bugfix/transform-v8-static-class-fields-redefine-readonly": () => bugfixV8StaticClassFieldsRedefineReadonly,
...
if (!process.env.BABEL_8_BREAKING) {
    ...
    Object.assign(availablePlugins, {
        "syntax-async-generators": USE_ESM || IS_STANDALONE
            ? e()
            : () => require("@babel/plugin-syntax-async-generators"),
        "syntax-class-properties": USE_ESM || IS_STANDALONE
            ? e()
            : () => require("@babel/plugin-syntax-class-properties"),
        "syntax-class-static-block": USE_ESM || IS_STANDALONE
            ? e()
            : () => require("@babel/plugin-syntax-class-static-block"),
        "syntax-dynamic-import": USE_ESM || IS_STANDALONE
            ? e()
            : () => require("@babel/plugin-syntax-dynamic-import"),
        "syntax-export-namespace-from": USE_ESM || IS_STANDALONE
            ? e()
            : () => require("@babel/plugin-syntax-export-namespace-from"),
        "syntax-import-meta": USE_ESM || IS_STANDALONE
            ? e()
            : () => require("@babel/plugin-syntax-import-meta"),
        "syntax-json-strings": USE_ESM || IS_STANDALONE
            ? e()
            : () => require("@babel/plugin-syntax-json-strings"),
        "syntax-logical-assignment-operators": USE_ESM || IS_STANDALONE
            ? e()
            : () => require("@babel/plugin-syntax-logical-assignment-operators"),
        "syntax-nullish-coalescing-operator": USE_ESM || IS_STANDALONE
            ? e()
            : () => require("@babel/plugin-syntax-nullish-coalescing-operator"),
        "syntax-numeric-separator": USE_ESM || IS_STANDALONE
            ? e()
            : () => require("@babel/plugin-syntax-numeric-separator"),
        "syntax-object-rest-spread": USE_ESM || IS_STANDALONE
            ? e()
            : () => require("@babel/plugin-syntax-object-rest-spread"),
        "syntax-optional-catch-binding": USE_ESM || IS_STANDALONE
            ? e()
            : () => require("@babel/plugin-syntax-optional-catch-binding"),
        "syntax-optional-chaining": USE_ESM || IS_STANDALONE
            ? e()
            : () => require("@babel/plugin-syntax-optional-chaining"),
        "syntax-private-property-in-object": USE_ESM || IS_STANDALONE
            ? e()
            : () => require("@babel/plugin-syntax-private-property-in-object"),
        "syntax-top-level-await": USE_ESM || IS_STANDALONE
            ? e()
