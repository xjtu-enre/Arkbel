import { isCallExpression, isExpressionStatement, isFunction, isIdentifier, isJSXIdentifier, isNewExpression, isPlaceholder, isStatement, isStringLiteral, removePropertiesDeep, traverse, } from "@babel/types";
...
function placeholderVisitorHandler(node, ancestors, state) {
    ...
    if (hasSyntacticPlaceholders &&
        ...
        throw new Error("'.placeholderWhitelist' and '.placeholderPattern' aren't compatible" +
