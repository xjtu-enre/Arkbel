...
export default (_, opts = {}) => {
    const { loose = false, useBuiltIns = false, decoratorsLegacy, decoratorsVersion, decoratorsBeforeExport, pipelineProposal, pipelineTopicToken, recordAndTupleSyntax, optionalChainingAssignVersion = "2023-07", } = opts;
    return {
        presets: [
            [
                presetStage2,
